...
namespace Herzog.Dapper.Contrib.Extensions
{
    public static partial class SqlMapperExtensions
    {
        ...
        {
            var proxy = entityToInsert as IProxy;
            if (proxy != null)
            {
            ...
            {
                var property = allProperties.ElementAt(i);
                adapter.AppendColumnName(sb, property.GetColumnName());
                if (i < allProperties.Count - 1)
                    sb.AppendFormat(", ");
            }
            ...
            var inserted = connection.Execute(sb.ToString(), entityToInsert, commandTimeout: commandTimeout, transaction: transaction);
            return inserted > 0;
        }
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            for (var i = 0; i < nonIdProps.Count; i++)
            {
                ...
                adapter.AppendColumnNameEqualsValue(sb, property.GetColumnName(), property.Name);  //fix for issue #336
        ...
        public static bool Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                var property = keyProperties.ElementAt(i);
                adapter.AppendColumnNameEqualsValue(sb, property.GetColumnName(), property.Name);
                if (i < keyProperties.Count - 1)
                    sb.AppendFormat(" and ");
            }
...
public partial class SqlCeServerAdapter : ISqlAdapter
{
    ...
    public void AppendColumnNameEqualsValue(StringBuilder sb, string columnName)
    {
        sb.AppendFormat("[{0}] = @{1}", columnName);
    }
